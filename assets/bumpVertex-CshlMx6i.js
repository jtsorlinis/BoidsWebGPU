import{t as e}from"./shaderStore-B3CsX8Dt.js";var t=`uvAttributeDeclaration`,n=`#ifdef UV{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var h=`bumpVertex`,g=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
