import{t as e}from"./shaderStore-B3CsX8Dt.js";import"./helperFunctions-C6fJxhG4.js";import"./logDepthFragment-kQVkB5SK.js";import"./logDepthDeclaration-_Q61YiyS.js";import"./clipPlaneFragment-UdjMuApa.js";import"./fogFragment-DTBfAqCZ.js";import"./oitFragment-BMJfrMyt.js";import"./mainUVVaryingDeclaration-Z8hkQdxD.js";import"./pbrBRDFFunctions-TxWstH3j.js";var t=`pbrFragmentDeclaration`,ee=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
#endif
}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=ae);var p=`hdrFilteringFunctions`,oe=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=oe);var m=`pbrDirectLightingFunctions`,h=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=h);var g=`pbrIBLFunctions`,_=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=_);var v=`pbrBlockAlbedoOpacity`,y=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);var b=`pbrBlockReflectivity`,x=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=x);var S=`pbrBlockAmbientOcclusion`,se=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=se);var C=`pbrBlockAlphaFresnel`,ce=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=ce);var w=`pbrBlockAnisotropic`,le=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=le);var T=`pbrBlockReflection`,ue=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=ue);var E=`pbrBlockSheen`,de=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=de);var D=`pbrBlockClearcoat`,fe=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=fe);var O=`pbrBlockIridescence`,k=`struct iridescenceOutParams
...
#endif
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=z);var B=`pbrBlockLightmapInit`,V=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=V);var H=`pbrBlockGeometryInfo`,pe=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=ge);var K=`pbrBlockFinalUnlitComponents`,_e=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
#endif
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=ye);var Y=`pbrBlockPrePass`,X=`#if SCENE_MRT_COUNT>0
...
#endif
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=be);var Q=`pbrPixelShader`,$=`#define PBR_FRAGMENT_SHADER
